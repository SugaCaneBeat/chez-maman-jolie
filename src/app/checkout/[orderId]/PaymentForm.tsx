    ...
    <>
      ...
      <div className="min-h-screen bg-dark text-white">
        ...
        <main className="max-w-xl mx-auto px-5 py-8 space-y-6">
          ...
          {/* Status banner — annoncé aux lecteurs d'écran */}
          {status === "processing" && (
            <div role="status" aria-live="polite" className="bg-amber-500/10 border border-amber-500/30 rounded-[5px] p-4 flex items-start gap-3">
              <svg aria-hidden="true" className="w-5 h-5 text-amber-400 flex-shrink-0 animate-spin" fill="none" viewBox="0 0 24 24">
          ...
          {status === "success" && (
            <div role="status" aria-live="polite" className="bg-emerald-500/10 border border-emerald-500/30 rounded-[5px] p-4 flex items-start gap-3">
              <svg aria-hidden="true" className="w-5 h-5 text-emerald-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          {error && (
            <div role="alert" aria-live="assertive" className="bg-red-500/10 border border-red-500/30 rounded-[5px] p-4 flex items-start gap-3">
              <svg aria-hidden="true" className="w-5 h-5 text-red-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
