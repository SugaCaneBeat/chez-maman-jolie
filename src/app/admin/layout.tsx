    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <aside className="w-64 bg-[#111008] text-white flex-shrink-0 hidden md:flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-1">
          <Link href="/admin" className="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm text-white/70 hover:text-white hover:bg-white/5 transition-colors">
          ...
          <Link href="/admin/menu" className="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm text-white/70 hover:text-white hover:bg-white/5 transition-colors">
          ...
          <Link href="/admin/orders" className="flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm text-white/70 hover:text-white hover:bg-white/5 transition-colors">
