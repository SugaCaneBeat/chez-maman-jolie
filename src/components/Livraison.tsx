      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 relative z-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6 mb-20">
            {data.tunnel.map((s, i) => (
              <div key={s.step} className="text-center group">
                <div className="w-18 h-18 sm:w-22 sm:h-22 glass rounded-3xl flex items-center justify-center mx-auto mb-4 group-hover:bg-white/10 group-hover:scale-110 transition-all duration-500">
        ...
        <ScrollAnimation delay={300}>
          <div className="grid sm:grid-cols-3 gap-4">
            <div className="glass rounded-2xl p-6 text-center hover:bg-white/8 transition-all">
