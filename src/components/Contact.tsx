      ...
      <div className="max-w-5xl mx-auto px-5 sm:px-8 relative z-10">
        ...
        <ScrollAnimation delay={100}>
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-5">
            {/* Phone — tall card */}
            <div className="col-span-2 sm:col-span-1 sm:row-span-2 glass rounded-3xl p-6 sm:p-8 flex flex-col justify-between hover:bg-white/8 transition-all group">
              <div className="w-14 h-14 glass rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
              ...
              <div>
                ...
                <a href="tel:+33712345678" className="text-primary font-semibold text-lg hover:text-primary-light transition-colors">
                  07 12 34 56 78
                </a>
              </div>
            </div>
            ...
            {/* WhatsApp — wide card */}
            <div className="col-span-2 sm:col-span-3 glass rounded-3xl p-6 sm:p-8 hover:bg-white/8 transition-all group bg-gradient-to-br from-[#25D366]/10 to-transparent">
              <div className="flex items-center gap-5">
                <div className="w-14 h-14 bg-[#25D366]/15 rounded-2xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform">
            ...
            {/* Horaires */}
            <div className="glass rounded-3xl p-6 hover:bg-white/8 transition-all group">
              <div className="w-10 h-10 glass rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform">
            ...
            {/* Traiteur — wide */}
            <div className="col-span-2 glass rounded-3xl p-6 sm:p-8 hover:bg-white/8 transition-all group bg-gradient-to-br from-primary/5 to-transparent">
              <div className="flex items-center gap-5">
