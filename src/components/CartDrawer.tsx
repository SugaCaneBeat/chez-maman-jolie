        ...
        {items.length > 0 && (
          <div className="px-6 py-5 border-t border-white/5 space-y-4">
            ...
            <a
              ...
              className="group flex items-center justify-center gap-3 w-full bg-[#25D366] hover:bg-[#20BD5A] text-white font-bold py-4 rounded-2xl text-base transition-all hover:scale-[1.02] shadow-lg shadow-[#25D366]/20"
            >
