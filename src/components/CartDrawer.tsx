      ...
      >
        ...
        {showPayment ? (
          ...
          <div className="flex-1 overflow-y-auto px-6 py-6 space-y-5">
            ...
            {/* Order summary */}
            <div className="glass rounded-[5px] p-4 space-y-2">
            ...
            <div className="glass rounded-[5px] p-5 space-y-3">
              <div className="flex items-center gap-3 mb-1">
                <div className="w-10 h-10 bg-blue-500/10 rounded-[5px] flex items-center justify-center">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3 mt-2">
                        <button
                          ...
                          className="w-7 h-7 rounded-[5px] bg-white/5 hover:bg-white/10 flex items-center justify-center transition-colors"
                        >
                        ...
                        <button
                          ...
                          className="ml-auto w-7 h-7 rounded-[5px] hover:bg-accent/20 flex items-center justify-center transition-colors"
                        >
              ...
              <div className="px-6 py-5 border-t border-white/5 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    disabled={saving}
                    className="group flex flex-col items-center justify-center gap-2 bg-[#25D366] hover:bg-[#20BD5A] text-white font-bold py-3.5 rounded-[5px] text-sm transition-all hover:scale-[1.02] shadow-lg shadow-[#25D366]/20 disabled:opacity-50"
                  >
                  ...
                  <button
                    ...
                    className="group flex flex-col items-center justify-center gap-2 bg-gradient-to-r from-primary to-primary-light hover:from-primary-light hover:to-primary text-dark font-bold py-3.5 rounded-[5px] text-sm transition-all hover:scale-[1.02] shadow-lg shadow-primary/20"
                  >
