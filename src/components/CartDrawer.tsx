              ...
              <div className="px-6 py-5 border-t border-white/5 space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    disabled={saving}
                    className="group flex flex-col items-center justify-center gap-2 bg-[#25D366] hover:bg-[#20BD5A] text-white font-bold py-3.5 rounded-2xl text-sm transition-all hover:scale-[1.02] shadow-lg shadow-[#25D366]/20 disabled:opacity-50"
                  >
